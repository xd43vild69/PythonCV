...
# configure window
       ...
       # u = Lora.pathx
        ...
        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebar_frame, text="Augmentation", command=self.normalizer)
        ...
        self.source = customtkinter.CTkEntry(self, placeholder_text="SourceImgs")
        ...
        self.total_files = customtkinter.CTkEntry(self, placeholder_text="QuantityFiles")
        ...
        self.total_repeats = customtkinter.CTkEntry(self, placeholder_text="Repets")
        self.total_repeats.place(x=360, y=160)

        self.epochs = customtkinter.CTkLabel(self, text="Epochs")
        self.epochs.place(x=200, y=210)
        self.total_epochs = customtkinter.CTkEntry(self, placeholder_text="Epochs")
        ...
        self.total_batch = customtkinter.CTkEntry(self, placeholder_text="BatchSize")
        ...
        self.total_steps = customtkinter.CTkEntry(self, placeholder_text="totalTrain")
